...
@Component({
  selector: 'app-list-allocations-lits',
  templateUrl: './list-allocations-lits.component.html',
  styleUrls: ['./list-allocations-lits.component.scss']
})
export class ListAllocationsLitsComponent implements OnInit , AfterViewInit{
  ...
  ouvrirAjout() {
    this.router.navigate(['/allocations-lits']); // Remplacez par le chemin de votre composant d'ajout
  }
