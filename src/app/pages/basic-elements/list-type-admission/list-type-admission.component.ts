...
@Component({
  selector: 'app-list-type-admission',
  templateUrl: './list-type-admission.component.html',
  styleUrls: ['./list-type-admission.component.scss']
})
export class ListTypeAdmissionComponent implements OnInit , AfterViewInit{
  ...
  ouvrirAjout() {
    this.router.navigate(['/admissions-facturables']); // Remplacez par le chemin de votre composant d'ajout
  }
