...
@Component({
  selector: 'app-dashboard-hospitalisation',
  templateUrl: './dashboard-hospitalisation.component.html',
  styleUrls: ['./dashboard-hospitalisation.component.scss']
})

export class DashboardHospitalisationComponent implements OnInit {
