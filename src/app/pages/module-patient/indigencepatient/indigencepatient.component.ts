...
@Component({
  selector: "app-indigencepatient",
  templateUrl: "./indigencepatient.component.html",
  styleUrls: ["./indigencepatient.component.scss"],
})
export class IndigencepatientComponent implements OnInit {
