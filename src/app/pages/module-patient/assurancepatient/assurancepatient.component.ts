...
@Component({
  selector: "app-assurancepatient",
  templateUrl: "./assurancepatient.component.html",
  styleUrls: ["./assurancepatient.component.scss"],
})


export class AssurancepatientComponent implements OnInit {
