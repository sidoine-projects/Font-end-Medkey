...
@Component({
  selector: "app-forfaitfacturation",
  templateUrl: "./forfaitfacturation.component.html",
  styleUrls: ["./forfaitfacturation.component.scss"],
})
export class ForfaitfacturationComponent implements OnInit {
