...
@Component({
  selector: "app-enquetes-interventions",
  templateUrl: "./enquetes-interventions.component.html",
  styleUrls: ["./enquetes-interventions.component.scss"],
})
export class EnquetesInterventionsComponent implements OnInit {
  constructor(private router: Router) {}
  ouvrirAjout() {
    this.router.navigate(["/enquete"]); // Remplacez par le chemin de votre composant d'ajout
  }
