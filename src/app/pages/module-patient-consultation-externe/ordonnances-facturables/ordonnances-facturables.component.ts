...
@Component({
  selector: "app-ordonnances-facturables",
  templateUrl: "./ordonnances-facturables.component.html",
  styleUrls: ["./ordonnances-facturables.component.scss"],
})
export class OrdonnancesFacturablesComponent implements OnInit {
