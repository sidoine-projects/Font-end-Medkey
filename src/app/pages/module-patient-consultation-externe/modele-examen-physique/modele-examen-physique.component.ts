...
@Component({
  selector: "app-modele-examen-physique",
  templateUrl: "./modele-examen-physique.component.html",
  styleUrls: ["./modele-examen-physique.component.scss"],
})
export class ModeleExamenPhysiqueComponent implements OnInit {
