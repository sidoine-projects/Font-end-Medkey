...
@Component({
  selector: "app-pharmacologie",
  templateUrl: "./pharmacologie.component.html",
  styleUrls: ["./pharmacologie.component.scss"],
})
 
export class PharmacologieComponent implements OnInit {
