...
@Component({
  selector: "app-afacturable",
  templateUrl: "./afacturable.component.html",
  styleUrls: ["./afacturable.component.scss"],
})
export class AfacturableComponent implements OnInit {
  constructor(private router: Router) {}
  ouvrirAjout() {
    this.router.navigate(["/facturable"]); // Remplacez par le chemin de votre composant d'ajout
  }
