...
@Component({
  selector: "app-articlesfacturabl",
  templateUrl: "./articlesfacturabl.component.html",
  styleUrls: ["./articlesfacturabl.component.scss"],
})
export class ArticlesfacturablComponent implements OnInit {
  constructor(private router: Router) {}
  ouvrirAjout() {
    this.router.navigate(["/artfactumineur"]); // Remplacez par le chemin de votre composant d'ajout
  }
