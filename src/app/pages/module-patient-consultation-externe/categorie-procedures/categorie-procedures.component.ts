...
@Component({
  selector: "app-categorie-procedures",
  templateUrl: "./categorie-procedures.component.html",
  styleUrls: ["./categorie-procedures.component.scss"],
})
export class CategorieProceduresComponent implements OnInit {
  constructor(private router: Router) {}
  ouvrirAjout() {
    this.router.navigate(["/categorieprocedure"]); // Remplacez par le chemin de votre composant d'ajout
  }
