...
@Component({
  selector: "app-inventaire-petites-salles-soins",
  templateUrl: "./inventaire-petites-salles-soins.component.html",
  styleUrls: ["./inventaire-petites-salles-soins.component.scss"],
})
export class InventairePetitesSallesSoinsComponent implements OnInit {
  constructor(private router: Router) {}
  // ouvrirAjout() {
  //   this.router.navigate(["/inventairemedicament"]); // Remplacez par le chemin de votre composant d'ajout
  // }
