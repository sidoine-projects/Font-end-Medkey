...
@Component({
  selector: "app-modele-historique-maladies",
  templateUrl: "./modele-historique-maladies.component.html",
  styleUrls: ["./modele-historique-maladies.component.scss"],
})
export class ModeleHistoriqueMaladiesComponent implements OnInit {
