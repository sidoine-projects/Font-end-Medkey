...
@Component({
  selector: "app-categorieplainte",
  templateUrl: "./categorieplainte.component.html",
  styleUrls: ["./categorieplainte.component.scss"],
})
export class CategorieplainteComponent implements OnInit {
  constructor(private router: Router) {}
  ouvrirAjout() {
    this.router.navigate(["/categorieplainte"]); // Remplacez par le chemin de votre composant d'ajout
  }
